...
const faqData = [
  {
    ...
    answer: (<>
      <p>ישנם סוגי ריביות שונים במשכנתא, כולל ריבית קבועה, ריבית משתנה וריבית פריים:</p>
      <ul>
        <li><strong>ריבית קבועה:</strong> הריבית נשארת קבועה לאורך כל תקופת ההלוואה, מה שמאפשר תכנון מדויק של ההחזר החודשי ואינו מושפע מהעלאות ריבית עתידיות. זהו מסלול בטוח יותר, אך בדרך כלל הריבית תהיה גבוהה יותר בהשוואה לריבית משתנה.</li>
        <li><strong>ריבית משתנה:</strong> הריבית משתנה בהתאם לשיעור הריבית בשוק, בדרך כלל אחת לכמה חודשים או שנים. זה יכול להוביל לתשלומים חודשיים נמוכים יותר בהתחלה, אך יש סיכון שהריבית תעלה בעתיד, מה שיכול להגדיל את התשלומים החודשיים.</li>
        <li><strong>ריבית פריים:</strong> זוהי ריבית משתנה שמבוססת על ריבית בסיסית, לרוב ריבית בנק ישראל, בתוספת מרווח קבוע. זהו מסלול גמיש שיכול להיות משתלם, אך גם כאן יש סיכון לתנודתיות.</li>
      </ul>
      </>)
    ,
  },
  {
    ...
    answer: (<>
      <p>תהליך קבלת המשכנתא כולל מספר שלבים עיקריים:</p>
      <ol>
        <li><strong>1. פגישת ייעוץ:</strong> בשלב הראשון, כדאי לקבוע פגישה עם יועץ משכנתאות או בנקאי, שיסייע לכם להבין את האפשרויות הזמינות.</li>
        <li><strong>2. איסוף מסמכים:</strong> יש לאסוף את המסמכים הנדרשים, כגון תעודת זהות, תלושי שכר, דוחות מס, ואישור על הכנסות נוספות.</li>
        <li><strong>3. הגשת בקשה לבנק:</strong> לאחר שהכנתם את המסמכים, יש להגיש את הבקשה לבנק או לגוף המלווה.</li>
        <li><strong>4. קבלת אישור עקרוני:</strong> הבנק יבצע בדיקות ויוציא אישור עקרוני, שמצביע על כך שאתם עומדים בתנאים לקבלת ההלוואה.</li>
        <li><strong>5. חתימה על המשכנתא:</strong> לאחר קבלת האישור הסופי, תתבצע החתימה על ההסכם והכספים ישוחררו לרכישת הנכס.</li>
      </ol>
      </>)
    ,
  },
  {
    ...
    answer: (<>
      <p>מחזור משכנתא הוא תהליך שבו לוקחים הלוואה חדשה כדי להחליף את ההלוואה הקיימת, לרוב במטרה לשפר את התנאים:</p>
      <ul>
        <li><strong>חיסכון בכסף:</strong> מחזור יכול לחסוך כסף במידה והתנאים הכלכליים השתנו (כגון ירידת ריבית) או שהמשכנתא הראשונית לא תואמת לצרכים הנוכחיים שלכם.</li>
        <li><strong>התאמה לצרכים חדשים:</strong> אם המציאות הכלכלית שלכם השתנתה (כמו שינוי בהכנסות או הוצאות), מחזור יכול לאפשר לכם להתאים את המשכנתא למצבכם הנוכחי.</li>
        <li><strong>ייעוץ מקצועי:</strong> חשוב להתייעץ עם מומחה לפני שמבצעים מחזור, שכן ישנם פרטים רבים שצריך לקחת בחשבון כמו עלויות מחזור, ריביות והאם יש קנס על פירעון מוקדם.</li>
      </ul>
    </>),
  },
  {
    question: "כיצד יועץ משכנתאות יכול לעזור לי?",
    answer: (<>      <p>יועץ משכנתאות מקצועי מציע מגוון שירותים שיכולים להקל עליכם בתהליך רכישת הדירה:</p>
      <ul>
        <li><strong>הבנת אפשרויות:</strong> היועץ יכול לעזור לכם להבין את האפשרויות השונות הקיימות בשוק, ולסייע בבחירה בין סוגי המשכנתאות.</li>
        <li><strong>תמהיל הלוואה נכון:</strong> הוא יכול לסייע לכם לבחור את תמהיל ההלוואה הנכון, כך שתוכלו לקבל את התנאים הטובים ביותר בהתאם למצבכם הכלכלי.</li>
        <li><strong>שיפור תנאים פיננסיים:</strong> יועץ מנוסה יכול לנהל משא ומתן עם הבנקים במקומכם, מה שיכול להוביל לחיסכון משמעותי בהחזר החודשי ובסך ההוצאות הכוללות.</li>
        <li><strong>ליווי לאורך כל התהליך:</strong> יועץ משכנתאות מלווה אתכם בכל שלב בתהליך, מסביר מושגים פיננסיים מורכבים ומסייע בהכנת המסמכים הנדרשים.</li>
      </ul>
      </>
),
  },
