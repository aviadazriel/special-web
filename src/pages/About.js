  ...
  const faqData = [
    {
      ...
      answer: (
        <ul>
          <li>
            להפוך את תהליך קבלת המשכנתא לפשוט, שקוף ונגיש לכל אחד.
          </li>
          <li>
            להעניק ללקוחות יחס אישי ומקצועי שמאפשר להם לקבל החלטות פיננסיות
            מושכלות.
          </li>
          <li>
            לעזור ללקוחות לחסוך כסף באמצעות תמהיל משכנתא חכם ותנאים משופרים.
          </li>
        </ul>
      ),
    },
    {
      ...
      answer: (
        <ol>
          <li>
            ליווי מלא מא' ועד ת', כולל ייעוץ, בניית תמהיל, מו"מ מול הבנקים
            וטיפול במסמכים.
          </li>
          <li>זמינות וגמישות במתן שירות, גם מעבר לשעות העבודה.</li>
          <li>
            עבודה עם כל הבנקים בישראל, תוך השגת התנאים הטובים ביותר בשוק.
          </li>
        </ol>
      ),
    },
    {
      ...
      answer: (
        <ul>
          ...
          <li>לקוחות המעוניינים למחזר משכנתא ולהפחית עלויות.</li>
        </ul>
      ),
    },
    {
      ...
      answer: (
        <ol>
          <li>
            <strong>פגישת ייעוץ ראשונית:</strong> נבצע סקירה של מצבכם הפיננסי
            ונבין את הצרכים שלכם.
          </li>
          <li>
            <strong>בניית תמהיל מותאם אישית:</strong> ניצור תמהיל שמותאם
            ליכולות ההחזר ולצרכים שלכם.
          </li>
          <li>
            <strong>מו"מ מול הבנקים:</strong> נשיג עבורכם את התנאים הטובים
            ביותר.
          </li>
          <li>
            <strong>מעקב וליווי:</strong> נוודא שכל המסמכים מסודרים ושכל התהליך
            מתנהל לשביעות רצונכם.
          </li>
        </ol>
      ),
    },
    {
      ...
      answer: (
        <ul>
          <li>
            יחס אישי ומותאם אישית לצרכים שלכם, עם שקיפות מלאה בכל שלב.
          </li>
